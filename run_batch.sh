...
echo ""
echo "📊 Experiment 2: The Impact of Red Agent Memory"
...
echo ""
echo "📊 Experiment 3: The Impact of Border Patrol"
...
echo ""
echo "📊 Experiment 4: Initial Waste Distribution"
...
echo ""
echo "📊 Experiment 5: Quantitative Scaling (Robots, Vision & Waste Count)"
...
python batch_experiments.py \
    --n-waste 16,32,48 \
    --n-green-robots 2,4,6 \
    --n-yellow-robots 1,2,4 \
    --n-red-robots 1,2 \
    --vision 1,2,3 \
    --iterations $ITERATIONS \
    --max-steps $MAX_STEPS \
...
echo ""
echo "📊 Experiment 6: Vision as a Communication Fallback"
...
echo ""
echo "📊 Experiment 7: Extreme Crowding & Deadlock Stress Test"
...
echo ""
echo "📊 Experiment 8: The 'Lone Wolf' Baseline"
